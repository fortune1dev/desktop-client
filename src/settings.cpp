...
constexpr quint16 DEFAULT_MAIN_WALLETD_RPC_PORT = 8828;
...
constexpr quint16 DEFAULT_MAIN_BYTECOIND_RPC_PORT = 8888;
...
constexpr char DEFAULT_WORK_DIR[] = ".fortune1";
#endif

const constexpr char* DEFAULT_MINING_POOLS[] = { "coop.fortune1.money:8888" };
